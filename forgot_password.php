...
<!--      <link rel='shortcut icon' href='Hippocampus.ico' type='image/x-icon'/ >-->
 ...
 <body>
         ...
         <header id="full">
        <span class="left min-five"><a href="index.php">Hippocampus</a></span>
...
$formcontent=" \r\n You have requested a password reset on Hippocampus. \r\n Go to Hippocampus to reset your password for ' $username ':\r\nhttp://isobellennox.com/projects/hippocampus/reset_password.php?user_id=".$user_id."&token=".time()."\r\nThis link will be good for one hour.";
$subject = "Password Reset On Hippocampus";
